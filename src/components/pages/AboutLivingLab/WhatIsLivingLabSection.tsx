...
const WhatIsLivingLabSection: React.FC = () => {
  return (
    <section className="bg-primary mb-32">
      <div className="justify-center md:justify-normal flex flex-wrap md:flex-nowrap flex-row items-center content-layout w-full py-20 h-auto md:h-[calc(100vh-var(--sticky-header-height))] md:max-h-[64rem]">
        <div className="block md:shrink-0 shrink-1 grow-0">
          <h2 className="mb-12 text-6xl font-bold text-white">
            What is Living Lab?
          </h2>
          <p className="mb-3 text-2xl font-semibold underline underline-offset-4 text-left sm:text-center md:text-left">
            "살아 있는 실험실"에 대하여 알아봅시다.
          </p>
          <p className="text-lg font-medium whitespace-pre-wrap  text-left sm:text-center md:text-left">
            {
